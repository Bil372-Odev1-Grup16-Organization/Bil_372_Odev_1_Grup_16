...
<html>
    ...
    <nav class="navtop">
      <div>
        ...
        <a href="org_read_brand_organisations.php" style="margin-left: 450px; font-size: 20px;" ><i class="fas fa-school"></i>Brand Organisations</a>
        <a href="org_read_flow.php" style="margin-left: 50px; font-size: 20px;" ><i class="fas fa-exchange-alt"></i>Flow</a>
